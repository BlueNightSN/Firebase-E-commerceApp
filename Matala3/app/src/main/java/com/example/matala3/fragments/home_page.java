...
public class home_page extends Fragment {
    ...
    private Product selectedProduct = null; // Track selected product
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnAddProduct.setOnClickListener(v -> {
            if (navController != null) {
                ...
                Toast.makeText(getActivity(), "Navigation error!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void removeProductFromCart(Product product) {
        ...
        if (user != null) {
            String userId = user.getUid();
            DocumentReference productRef = db.collection("users").document(userId).collection("cart").document(product.getId());
